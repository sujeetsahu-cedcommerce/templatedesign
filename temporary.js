...
function del()
{
   ...
   /*var l= document.getElementById("Samsung").value;
   var m= document.getElementById("Nokia").value;
   var n= document.getElementById("Xiaomi").value;
   var o= document.getElementById("Motorola").value;
